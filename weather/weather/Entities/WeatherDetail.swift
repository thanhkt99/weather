...
class WeatherDetail : Codable
{
    ...
    {
        switch icon {
        case "a01d", "a01n", "a02d", "a02n", "a03d", "a03n", "a04d", "a04n", "a05d", "a05n", "a06d", "a06n", "c04d", "c04n": return "smoke"
        case "r01d", "r01n", "r02d", "r02n", "f01d", "f01n", "r04d", "r04n", "r05d", "r05n", "r06d"," r06n": return "cloud.rain"
